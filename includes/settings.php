...
function nova_bridge_suite_register_settings(): void {
    ...
    add_settings_field(
        ...
        [
            'key'         => 'post_resolver',
            'label'       => 'Enable Post Resolver endpoint',
            'description' => 'Adds /wp-json/nova-post-resolver/v1/resolve/<id> for endpoint resolution.',
        ]
    );
...
function nova_bridge_suite_render_settings_page(): void {
    ...
    <div class="wrap">
        ...
        <p><?php echo esc_html__( 'Choose which NOVA modules are active. The core bridge always remains on.', 'nova-bridge-suite' ); ?></p>
...
function nova_bridge_suite_render_core_section(): void {
    echo '<p>' . esc_html__( 'The core NOVA Bridge is always enabled.', 'nova-bridge-suite' ) . '</p>';
}
